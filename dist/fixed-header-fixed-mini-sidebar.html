...
<html class="no-js">
  <head>
    <meta charset="UTF-8">
    <title>Fixed Header and Fixed Mini Menu</title>
    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-building"></i>&nbsp; Fixed Header and Fixed Mini Menu</h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
      ...
      <div id="content">
        <div class="outer">
          <div class="inner bg-light lter">
            <h2>Code</h2>
            <pre><code class="language-markup">&lt;body class=&quot;menu-affix sidebar-left-mini&quot;&gt;
    &lt;nav class=&quot;navbar navbar-inverse navbar-fixed-top&quot;&gt;
    ...
    &lt;/nav&gt;
&lt;/body&gt;</code></pre>
