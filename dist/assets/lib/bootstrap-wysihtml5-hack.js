!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
                    ...
                    "<a class='btn btn-default" + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='glyphicon glyphicon-align-right'></i></a>" +
                    "<a class='btn btn-default" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='glyphicon glyphicon-align-left'></i></a>" +
                    "</div>" +
                    "</li>";
        },
        "link": function(locale, options) {
            ...
            return "<li>" +
                    ...
                    "<a href='#' class='btn btn-danger' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                    ...
                    "</div>" +
                    "<div class='modal-footer'>" +
                    "<a href='#' class='btn btn-danger' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["assets/lib/wysihtml5/lib/css/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
