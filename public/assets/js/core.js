  ...
  */
  ...
  class MetisMenu {
      ...
      constructor(element, options) {
          ...
          this.config = Object.assign(Object.assign({}, Default$b), options);
          this.disposed = false;
          this.triggerArr = [];
          this.init();
      }
  ...
  */
  ...
  Metis.collapseCard = () => {
    ...
    [...triggers].map((trigger) => {
      ...
      if (cardBody) {
        const collapseCard = new Collapse(cardBody);
  ...
  Metis.metisAnimatePanel = () => {
    return new Error("Metis.metisAnimatePanel() deprecated.");
  };
   ...
   */
  Metis.navBar = () => {
    return new Error("Metis.navBar() deprecated.");
  };
